          ...
          child: Column(
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  IconCard(iconData: Icons.home, text: 'Lugares',),
              ...
              Row(
                ...
                children: <Widget>[
                  Padding(
                    padding: const EdgeInsets.only(left:8.0),
                    child: Text('Buenas Experiencias', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500),),
